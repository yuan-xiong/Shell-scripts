...
extern void trace_find_cmdline_parent(int pid, char comm[], int *ppid, char p_comm[]);
extern void trace_find_cmdline_grandparent(int pid, char comm[], int *ppid, char p_comm[], int *gpid, char g_comm[]);
extern void trace_find_cmdline_ggparent(int pid, char comm[], int *ppid, char p_comm[], int *gpid, char g_comm[], int *ggpid, char gg_comm[]);
